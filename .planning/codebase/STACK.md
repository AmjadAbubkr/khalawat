...
| Compose Runtime | (BOM) | State management (mutableStateOf for OnboardingState) |
| Material3 | (BOM) | Material Design 3 components |
| Material Icons Extended | 1.7.6 | Extended icon set (Shield, Warning, Check) |
...
| `android.content.SharedPreferences` | App preferences (onboarding state, PIN, language, disconnect count) |
...
| `androidx.compose.runtime.mutableStateOf` | Compose-observable state in OnboardingState |
