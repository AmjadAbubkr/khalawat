...
│       │   │   ├── onboarding\
│       │   │   │   ├── OnboardingState.kt   # 5-screen state machine
...
│       │   │   ├── server\
│       │   │   │   └── InterventionServer.kt # NanoHTTPD on port 8080
│       │   │   ├── ui\
...
│       │   │       └── KhalawatVpnService.kt      # Android VpnService shell
│       │   └── res\
...
│           ├── server\InterventionServerTest.kt     # 6 tests
...
| Category | Lines |
|----------|-------|
| Main source (Kotlin) | ~1,800 |
| Test source (Kotlin) | ~1,200 |
| HTML intervention pages | ~250 |
| Build configs (Gradle) | ~130 |
| Assets (blocklist) | ~50 |
| **Total** | **~3,400** |
